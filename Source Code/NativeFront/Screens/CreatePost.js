...
import {Alert, ActivityIndicator, NativeModules, Platform, StyleSheet, Pressable, View, Text, Image, TouchableOpacity, useWindowDimensions, ScrollView } from 'react-native';
...
storeImage(image, `${id}.png`)
  ...
  return (
    ...
    <View>
        ...
        <Text style = {{marginLeft: 10}}>Create me {userObj.first_name}</Text>
        ...
        />
        <Text style = {[{fontSize : 20, marginLeft : 50}]}> Please take photos of the food</Text> 
