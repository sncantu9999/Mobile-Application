...
class Post(models.Model):
    id = models.CharField(primary_key = True, defaultzz = '', max_length = 50)
    uri = models.CharField(default = '', blank = True, max_length = 9000000)
    ...
    group_directed = models.BooleanField(default=False, blank = True)
